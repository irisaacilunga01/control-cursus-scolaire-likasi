...
import { Eleve, Frais_enrolement, Paiement } from "@/type"; // Importez tous les types
...
interface PaiementFormProps {
  ...
  frais: Frais_enrolement[]; // Liste des frais
}
    ...
    <Form {...form}>
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Frais Associés</FormLabel>
              <Select
                onValueChange={field.onChange}
                value={
                  field.value !== null && field.value !== undefined
