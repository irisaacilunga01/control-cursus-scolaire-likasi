...
import { Annee_scolaire, Classe, Eleve, Inscription, Option } from "@/type"; // Importez tous les types
        ...
        async (payload) => {
          ...
          if (
            ...
            inscriptionWithRelations = {
              ...inscriptionData,
              eleves: eleveRes.success ? eleveRes.data : undefined,
              classes: classeRes.success ? classeRes.data : undefined,
              annee_scolaires: anneescolaireRes.success
