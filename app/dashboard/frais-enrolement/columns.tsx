...
import { Annee_scolaire, Frais_enrolement } from "@/type"; // Assurez-vous d'importer Frais et Anneescolaire
...
type FraisDisplay = Frais_enrolement & {
  annee_scolaires?: Annee_scolaire; // La relation anneescolaire est incluse pour l'affichage
};
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Link
              ...
              href={`/dashboard/frais-enrolement/${frais.idfrais}/edit`}
            >
...
export const columns: ColumnDef<FraisDisplay>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return anneescolaire ? anneescolaire.intitule : "Non spécifiée";
    },
  },
  {
    id: "actions",
